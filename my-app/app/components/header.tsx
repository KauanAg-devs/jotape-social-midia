    ...
    return (
        <header className="py-4 relative w-screen flex justify-between">
            ...
            <div className="relative">
                ...
                className="w-72 md:w-[25rem] lg:w-[35rem] h-12 px-4 py-2 border-0 rounded-full bg-white shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                />
